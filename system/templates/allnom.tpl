    ...
    <table width="636" height="134" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
    	  <td height="30">会员价格：<font color="#FF0000">{$nomarr[nom_id].v_price}&nbsp;元</font></td>
  	      <td height="30" colspan="2" align="center" valign="middle"><input id="allshow" name="allshow" type="button" value="详情" class="showinfo" onclick="openshowcommo({$nomarr[nom_id].id})"  />  &nbsp;<input id="buy" name="buy" type="button" value="购买" class="buy" onclick="return buycommo({$nomarr[nom_id].id})" /></td>
    	</tr>
    </table>
