      ...
      <table width="636" height="134" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td height="30" colspan="2" align="center" valign="middle">
              <input id="allshow" name="allshow" type="button" value="详情" class="showinfo" onclick="openshowcommo({$newarr[new_id].id})"  />
              &nbsp;
              <input id="buy" name="buy" type="button" value="购买" class="buy" onclick="return buycommo({$newarr[new_id].id})" />
            </td>
          </tr>
        </table>
