  ...
  <tr>
      ...
      <table width="295" height="307" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        {counter start=1 skip=1 direction=up print=false assign=count}
         {section name=new_id loop=$newarr}
          <td align="left" valign="top">
            <table width="150" height="150" align="left" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="100" align="center" valign="middle">
                    <a style="cursor:hand;" onclick="">
                      <img src="{$newarr[new_id].pics}" width="100" height="80" alt="{$newarr[new_id].name}" style="border:1px solid #f0f0f0;" onclick="openshowcommo({$newarr[new_id].id})" />
                    </a>
                  </td>
                </tr>
