...
&nbsp;元</font></td>
  	      <td height="30" colspan="2" align="center" valign="middle"><input id="allshow" name="allshow" type="button" value="详情" class="showinfo" onclick="openshowcommo(<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['id']; ?>
)"  />  &nbsp;<input id="buy" name="buy" type="button" value="购买" class="buy" onclick="return buycommo(<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['id']; ?>
)" /></td>
    	</tr>
    </table>
