...
" style="border: 1px solid #f0f0f0;"></td>
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="right"><input id="buy" name="buy" type="button" value="购买" class="buy" onclick="return subbuycommo(<?php echo $this->_tpl_vars['shoarr'][$this->_sections['sho_id']['index']]['id']; ?>
)" ></td>
  </tr>
  <?php endfor; endif; ?>
</table>