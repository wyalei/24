...
if($reback === false){
	...
	echo "add time: " . $addtime . "<br/>";
	$sql="insert into tb_commo(name,pics,info,addtime,area,model,class,brand,stocks,m_price,v_price,fold,isnew,isnom)values('".$_POST['name']."','".$reback."','".$_POST['info']."','".$addtime."','".$_POST['area']."','".$_POST['model']."','".$_POST['stype']."','". $_POST['brand']."','".$_POST['stocks']."','".(float)$_POST['m_price']."','".(float)$_POST['m_price'] * (float)$_POST['fold'] / 10 ."','".(float)$_POST['fold']."','".$_POST['isnew']."','".$_POST['isnom']."')";
	// echo "add comm sql: " . $sql;
