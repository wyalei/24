...
?>
    <tr>
      <td height="25" align="center" valign="middle" class="left">
        ...
        <input id="moditype<?php echo $this->_tpl_vars['bigarray'][$this->_sections['big_id']['index']]['id']; ?>
...
" style="border-color:#996633;" />
      </td>
      
      <td height="25" align="center" valign="middle" class="right">
        <input id="modify" name="modify" type="button" class="btn" value="修改" onclick="javascript:modifytype(<?php echo $this->_tpl_vars['bigarray'][$this->_sections['big_id']['index']]['id']; ?>
);" style="border-color:#FFFFFF;"/>
        <input id="delete" name="delete" type="button" value="删除" class="btn" onclick="javascript:delbigtype(<?php echo $this->_tpl_vars['bigarray'][$this->_sections['big_id']['index']]['id']; ?>
);" style="border-color:#FFFFFF;">
      </td>
    </tr>
...
?>
    ...
    <tr>
      <td height="25" align="center" valign="middle" class="left" style="text-indent: 50px;" >
        ...
        <input id="modtype<?php echo $this->_tpl_vars['smallarray'][$this->_sections['small_id']['index']]['id']; ?>
...
" style="border-color:#996633;" />
      ...
      <td height="25" align="center" valign="middle" class="right">
        <input id="modidfy" name="modify" type="button" value="修改" class="btn" onclick="javascript:modifytype(<?php echo $this->_tpl_vars['smallarray'][$this->_sections['small_id']['index']]['id']; ?>
)" style="border-color:#FFFFFF;"/>
        <input id="delete" name="delete" type="button" value="删除" class="btn" onclick="javascript:delsmalltype(<?php echo $this->_tpl_vars['smallarray'][$this->_sections['small_id']['index']]['id']; ?>
)" style="border-color:#FFFFFF;">
      </td>
    </tr>
    <?php endif; ?>
